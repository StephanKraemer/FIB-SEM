function [m sx sy]=MyReadDM3(filename,logfile)
% function [m sx sy]=MyReadDM3(filename,logfile)
...
%
% SK (09/06/2011)
% Suppressed the logfile output to the console. Save only a logfile.
%
% SK (09/30/2013)
% permute images to get same image orientation as seen on microscope
%
% Search for '% SK' to see where changes were done.
%
% ______________________________________________________________________
...
% SK
m = permute(m,[2 1]);           % permute image to get corret orientation
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %
    % SK: don't output to console (handles = 1)
    %
